...
module.exports = function(app) {
    ...
    app.get("/accounts-link/accounts-link-list",[jwt_middleware.verify_token, jwt_middleware.is_manager],accounts_link_controller.accounts_link_list);
    app.get("/accounts-link/accounts-link-list-active",[jwt_middleware.verify_token, jwt_middleware.is_manager],accounts_link_controller.accounts_link_list_active);
    app.get("/accounts-link/get-accounts-link/:accounts_link_id",[jwt_middleware.verify_token, jwt_middleware.is_manager],accounts_link_controller.get_accounts_link);
