...
module.exports = function(app) {
    ...
    app.get("/users/get-user/:user_id", [jwt_middleware.verify_token, jwt_middleware.is_manager],user_controller.get_user);
    ...
    app.get("/users/user-count-branch/",[jwt_middleware.verify_token, jwt_middleware.is_manager],user_controller.user_count_branch);
