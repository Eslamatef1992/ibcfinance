...
module.exports = function(app) {
    ...
    app.get("/financial-year/financial-year-list",[jwt_middleware.verify_token, jwt_middleware.is_manager],financial_year_controller.financial_year_list);
    app.get("/financial-year/financial-year-list-active",[jwt_middleware.verify_token, jwt_middleware.is_manager],financial_year_controller.financial_year_list_active);
