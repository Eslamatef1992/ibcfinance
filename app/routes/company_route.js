...
module.exports = function(app) {
    ...
    app.get("/company/company-list-active",[jwt_middleware.verify_token, jwt_middleware.is_manager],company_controller.company_list_active);
    app.get("/company/get-company/:company_id",company_controller.get_company);
