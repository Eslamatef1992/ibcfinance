...
module.exports = function(app) {
    ...
    app.get("/settings/get-user-language/:user_id",[jwt_middleware.verify_token, jwt_middleware.is_manager],setting_controller.get_user_language);
    app.put("/settings/change-user-language/:user_id",[jwt_middleware.verify_token, jwt_middleware.is_manager],setting_controller.change_user_language);
    app.get("/settings/get-user-theme/:user_id",[jwt_middleware.verify_token, jwt_middleware.is_manager],setting_controller.get_user_theme);
    app.put("/settings/change-user-theme/:user_id",[jwt_middleware.verify_token, jwt_middleware.is_manager],setting_controller.change_user_theme);
};
