...
module.exports = function(app) {
    ...
    app.get("/branch/branch-list",[jwt_middleware.verify_token, jwt_middleware.is_manager],branch_controller.branch_list);
    app.get("/branch/branch-list-active/:company",[jwt_middleware.verify_token, jwt_middleware.is_manager],branch_controller.branch_list_active);
    app.get("/branch/get-branch/:branch_id",branch_controller.get_branch);
    app.get("/branch/get-branch-company/:company_id",[jwt_middleware.verify_token, jwt_middleware.is_manager],branch_controller.get_branch_company);
