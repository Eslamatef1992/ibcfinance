...
module.exports = function(app) {
    ...
    app.get("/voucher-type/voucher-type-list",[jwt_middleware.verify_token, jwt_middleware.is_manager],voucher_type_controller.voucher_type_list);
    app.get("/voucher-type/voucher-type-list-active",[jwt_middleware.verify_token, jwt_middleware.is_manager],voucher_type_controller.voucher_type_list_active);
    app.get("/voucher-type/get-voucher-type/:voucher_type_id",[jwt_middleware.verify_token, jwt_middleware.is_manager],voucher_type_controller.get_voucher_type);
